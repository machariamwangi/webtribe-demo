  ...
  <div className="bg-indigo-900 px-4 py-4">
    <div className="md:max-w-6xl md:mx-auto md:flex md:items-center md:justify-between">
      <div className="flex justify-between items-center">
        <a href="/" className="inline-block py-2 text-white text-xl font-bold">WebTribe Demo</a>
      ...
      <div className="hidden md:block">
        ...
        <a href="/signup" className="inline-block py-2 px-4 text-gray-700 bg-white hover:bg-gray-100 rounded-lg">Sign Up</a>
      </div>
    </div>
  </div>
